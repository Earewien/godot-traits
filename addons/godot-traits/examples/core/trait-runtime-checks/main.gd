...
func _ready() -> void:
    ...
    # Will print true !
    print("Is a Killable : %s" % GTraits.is_a(GTraitsCoreExampleKillable, npc))
    # Will print false !
    print("Is a Healthable : %s" % GTraits.is_a(GTraitsCoreExampleHealthable, npc))
    ...
    GTraits.as_a(GTraitsCoreExampleHealthable, npc)
